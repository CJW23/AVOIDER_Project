...
public class KinectPointController : MonoBehaviour {
	...
	void Update () {
        ...
        //else
        //{
        //    anim[0].Play("assault_combat_run");
        //}
        //if (Hand_Left.transform.position.y < 0.5)
        //{
        //    anim[1].Play("assault_combat_shoot");
        //}
    ...
    void Move()
    {
        ...
        if (Hand_Left.transform.position.y > 0.9 )
        {
        ...
        if (Hand_Right.transform.position.y > 0.9)
        {
            if (lmoving == false && rmoving ==false)
            {
                if (i == MIDDLE || i == LEND)
                {
